...
## 2026-05-18 — v9.1 acceptance sign-off recorded

- **2026-05-18 — v9.1 MRC Stage 2 ACCEPTED as development baseline** — Round 3 closed by `stage2-mrc-acceptance`. Sign-off authority: `docs/stage2/13.0-v9.1-acceptance-signoff.en.md` (with `.zh.md` mirror). 11 PASS + 1 MARGINAL (ruff on legacy/Round-2 files, out of Round 3 scope) + 0 FAIL against `docs/stage2/12.0-acceptance-gate.en.md` criteria. Final acceptance gate verdict PASS (self-consistency 0/0 across 5 MRC sheets; baseline + legacy ENV-SKIP). Conditions for production cutover: (a) operator captures real baseline XLSX + reruns gate in `--baseline` then `--legacy-mode live` mode; (b) DEGRADED validators replaced incrementally each carrying acceptance-gate evidence per AGENTS.md § 6.13. Known gaps tracked in sign-off § 7 (G2a env-blocked, real baseline pending, validators DEGRADED, lineage fixture-backed, export 501, 12.0 zh mirror missing, 34 legacy ruff errors). Next phases v9.2/v9.3/v9.4/v9.5 enumerated in sign-off § 8. See `plan.md` § 12 for the final commit table and verdict excerpt.
