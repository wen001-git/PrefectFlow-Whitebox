...
-- source: flow/remit_validation/servicer_validation_with_portdaily.py :: mrc_adv_validation (lines 583–632)
-- servicer: mrc  flag: MRC-relevant
-- remit_date: 2026-04-30
-- pattern: f-string-noexpr
-- placeholders to resolve: (none)
-- notes: module-level template (used via .replace() in caller)
