...
> **See also — G2a Redshift dependencies**
>
> Running the G2a snapshot export (`freeze_snapshot.py export`) requires Redshift
> VPN access and a Vault token. Before executing the export, consult the
> single-document prerequisite checklist:
> [`_g2a-redshift-dependencies.en.md`](_g2a-redshift-dependencies.en.md) /
> [`_g2a-redshift-dependencies.zh.md`](_g2a-redshift-dependencies.zh.md)
>
> *在运行 G2a 导出之前，须具备 Redshift VPN + Vault token。前提检查清单见上方链接。*
