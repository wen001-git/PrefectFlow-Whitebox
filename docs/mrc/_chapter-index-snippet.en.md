<!--
  Embeddable MRC Chapter Index — EN variant.
  Source of truth: docs/mrc/_chapter-index.md
  Embed this block at the top of every docs/mrc/*.en.md (after Purpose /
  Audience / Revision history block, before the first `# 1. ...` heading).
-->
