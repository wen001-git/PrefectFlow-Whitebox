<!--
  Embeddable MRC Chapter Index — ZH variant.
  Source of truth: docs/mrc/_chapter-index.md
  Embed this block at the top of every docs/mrc/*.zh.md (after Purpose /
  Audience / 修订历史 block, before the first `# 1. ...` heading).
-->
